...
module.exports = {
        ...
        try {
            ...
            await ST.transaction(async (t) => {
                inscriptions = await Student.findAll({
                    ...
                    include: [
                        {
                            attributes: ['id', 'document_number', 'address', 'gender', 'birth_date', 'phone', 'email', 'photo', [Fn('CONCAT', Col('paternal'), ' ', Col('maternal'), ' ', Col('name')), 'name'], 'updated_at'],
                            model: Person,
                            as: "Person"
                        },
                        {
        ...
        try {
            ...
            await ST.transaction(async (t) => {
                ...
                students = await Student.findAll({
                    attributes: ['id', 'type_entry', 'study_modality', 'id_organic_unit'],
                    include: [
                        {
                            required: true,
                            where: {id_process: req.params.id_process},
                            attributes: ['description', 'type_process', 'date_start'],
                            model: Admission_plan,
                            as: 'Admission_plan',
                            include: [
                                {
                                ...
                                },
                                {
                                    ...
                                    include: [
                                        ...
                                        {
                                            required: true,
                                            attributes: ['denomination', 'code_local', 'code_faculty_unit'],
                                            model: Organic_unit,
                                            as: "Organic_unit_register",
                                            include: {
                        ...
                        {
                            required: true,
                            attributes: ['id_identification_document', 'id_ubigeo_birth', 'id_ubigeo_resident', 'id_nationality',
                                'document_number', 'name', 'paternal', 'maternal', 'gender', 'birth_date', 'just_last_name'],
                            model: Person,
                            as: 'Person'
                        },
                        {
                ...
                let tipoingresante, tipodocumento, tipoproceso, codigosedefilial, numerodocumento, nombres,
                    primerapellido,
                    segundoapellido, sexo, modalidadeingresotemp,
                    fechanacimiento, paisnacimiento, nacionality, ubigeonacimiento, ubigeoreisdencia,
                    codigofacultadunidad, codigoprograma, fechaingreso, modalidadeingreso, modalidadestudio, process,
                    year, programa
                ;
                for (let i = 0; i < students.length; i++) {
                    tipodocumento = students[i].Person ? students[i].Person.id_identification_document : null;
                    codigosedefilial = students[i].Admission_plan && students[i].Admission_plan.Program && students[i].Admission_plan.Program.Organic_unit_register
                    && students[i].Admission_plan.Program.Organic_unit_register.Campu ? students[i].Admission_plan.Program.Organic_unit_register.Campu.code : null;
                    tipoproceso = students[i].Admission_plan ? students[i].Admission_plan.type_process : null;
                    numerodocumento = students[i].Person ? students[i].Person.document_number : null;
                    nombres = students[i].Person ? students[i].Person.name : null;
                    primerapellido = students[i].Person ? students[i].Person.paternal : null;
                    segundoapellido = students[i].Person ? students[i].Person.maternal : null;
                    segundoapellido = students[i].Person ? students[i].Person.maternal : null;
                    sexo = students[i].Person ? students[i].Person.gender : null;
                    fechanacimiento = students[i].Person ? students[i].Person.birth_date : null;
                    nacionality = students[i].Person ? students[i].Person.id_nationality : null;
                    ubigeonacimiento = students[i].Person ? students[i].Person.id_ubigeo_birth : null;
                    ubigeoreisdencia = students[i].Person ? students[i].Person.id_ubigeo_resident : null;
                    codigofacultadunidad = students[i].Admission_plan && students[i].Admission_plan.Program && students[i].Admission_plan.Program.Organic_unit_register ? students[i].Admission_plan.Program.Organic_unit_register.code_faculty_unit : null;
                    codigoprograma = students[i].Admission_plan && students[i].Admission_plan.Program ? students[i].Admission_plan.Program.code : null;

                    fechaingreso = students[i].Admission_plan ? students[i].Admission_plan.date_start : null;
                    tipoingresante = moment(fechaingreso).format('L') >= 2020 ? 1 : 2;// NUEVO INGRESANTE (1) --- ANTES DE 2020 (2)
                    modalidadestudio = moment(fechaingreso).format('L') >= 2020 ? 3 : 1;


                    modalidadeingresotemp = students[i].Concept ? students[i].Concept.id : 81;
                    modalidadeingreso = modalidadeingresotemp === 81 ? 8 :
                        modalidadeingresotemp === 82 ? 2 : 3;

                    process = students[i].Admission_plan && students[i].Admission_plan.Process ? students[i].Admission_plan.Process.denomination : null;
                    year = students[i].Admission_plan && students[i].Admission_plan.Process && students[i].Admission_plan.Process.Academic_calendar ? students[i].Admission_plan.Process.Academic_calendar.denomination : null;
                    programa = students[i].Admission_plan && students[i].Admission_plan.Program ? students[i].Admission_plan.Program.description : 'No def';
                    ...
                    data.push({
                        ...
                        'PROCESO_ADMISION_PERIODO_INGRESO': year.substr(-4) + '-' + process.substr(-1),//aqui falta
    ...
    reportExecelEntry: async (req, res) => {
        try {
            ...
            await ST.transaction(async (t) => {
                ...
                let estado, planadmision, fechainicio, process, year, programa, unidadorganica, sede, documento, nombre,
                    apellidopaterno, apellidomaterno, modalidad;
                for (let i = 0; i < students.length; i++) {
                    estado = students[i].state;
                    planadmision = students[i].Admission_plan ? students[i].Admission_plan.denomination : null;
                    fechainicio = students[i].Admission_plan ? students[i].Admission_plan.date_start : null;
                    // proceso = students[i].Admission_plan ? students[i].Admission_plan.date_start : null;
                    programa = students[i].Admission_plan && students[i].Admission_plan.Program ? students[i].Admission_plan.Program.denomination : null;
                    unidadorganica = students[i].Admission_plan && students[i].Admission_plan.Program && students[i].Admission_plan.Program.Organic_unit_register ? students[i].Admission_plan.Program.Organic_unit_register.denomination : null;
                    sede = students[i].Admission_plan && students[i].Admission_plan.Program && students[i].Admission_plan.Program.Organic_unit_register && students[i].Admission_plan.Program.Organic_unit_register.Campu ? students[i].Admission_plan.Program.Organic_unit_register.Campu.denomination : null;
                    documento = students[i].Person ? students[i].Person.document_number : null;
                    nombre = students[i].Person ? students[i].Person.name : null;
                    apellidopaterno = students[i].Person ? students[i].Person.paternal : null;
                    apellidomaterno = students[i].Person ? students[i].Person.maternal : null;
                    modalidad = students[i].Concept ? students[i].Concept.denomination : null;
                    process = students[i].Admission_plan && students[i].Admission_plan.Process ? students[i].Admission_plan.Process.denomination : null;
                    year = students[i].Admission_plan && students[i].Admission_plan.Process && students[i].Admission_plan.Process.Academic_calendar ? students[i].Admission_plan.Process.Academic_calendar.denomination : null;
    ...
    reportExecelRegistrionOrganicUnit: async (req, res) => {
        ...
        try {
                ...
                include:
                    {
                        ...
                        include: [
                            ...
                            {
                                required: true,
                                attributes: ['id_identification_document', 'document_number', 'name', 'paternal', 'maternal', 'gender', 'birth_date'],
                                model: Person,
                                as: 'Person'
                            },
                            {
            ...
            let programa, unidadorganica, sede, documento, nombre, apellidopaterno, admission, apellidomaterno;
            for (let i = 0; i < students.length; i++) {
                programa = students[i].Student && students[i].Student.Program ? students[i].Student.Program.denomination : null;
                unidadorganica = students[i].Student && students[i].Student.Organic_unit_register ? students[i].Student.Organic_unit_register.denomination : null;
                sede = students[i].Student && students[i].Student.Organic_unit_register && students[i].Student.Organic_unit_register.Campu ? students[i].Student.Organic_unit_register.Campu.denomination : null;
                documento = students[i].Student && students[i].Student.Person ? students[i].Student.Person.document_number : null;
                nombre = students[i].Student && students[i].Student.Person ? students[i].Student.Person.name : null;
                apellidopaterno = students[i].Student && students[i].Student.Person ? students[i].Student.Person.paternal : null;
                apellidomaterno = students[i].Student && students[i].Student.Person ? students[i].Student.Person.maternal : null;
                admission = students[i].Student && students[i].Student.Admission_plan ? students[i].Student.Admission_plan.description : null;
    ...
    reportSuneduRegistration: async (req, res) => {
        ...
        try {
                ...
                include: [
                    ...
                    },
                    {
                        ...
                        include: [
                            ...
                            {
                                required: true,
                                attributes: ['id_identification_document', 'document_number', 'name', 'paternal', 'maternal', 'gender', 'birth_date', 'just_last_name'],
                                model: Person,
                                as: 'Person'
                            }
                        ]
            ...
            let codeLocal, peridoLectivo, tipoPeriodo, periodoAcademico, codeFacultadUnidad, codePrograma,
                codeProgramaAnterior, fechaCambioAnteior,
                cambioPrograma, tipoDocumento, nroDocumento, cicloAcademico, modalidaEstudio, fechaMatricula;
            for (let i = 0; i < _data.length; i++) {
                codeLocal = _data[i].Organic_unit_register ? _data[i].Organic_unit_register.code_local : null;

                peridoLectivo = 1;// 1 semestral
                tipoPeriodo = 1;//1 regular
                periodoAcademico = _data[i].Academic_semester.Academic_calendar.denomination.substr(-4) + '-' + _data[i].Academic_semester.denomination.substr(-2);
                codeFacultadUnidad = _data[i].Organic_unit_register ? _data[i].Organic_unit_register.code_faculty_unit : null;
                codePrograma = _data[i].Program ? _data[i].Program.code : null;
                cambioPrograma = 0;
                codeProgramaAnterior = null;
                fechaCambioAnteior = null;
                tipoDocumento = _data[i].Student && _data[i].Student.Person ? _data[i].Student.Person.id_identification_document : null;
                nroDocumento = _data[i].Student && _data[i].Student.Person ? _data[i].Student.Person.document_number : null;
                cicloAcademico = _data[i].number_registration;
                modalidaEstudio = _data[i].Student ? _data[i].Student.study_modality : null;
                tempFechaRegistration = _data[i].Academic_semester.denomination.substr(-2) === 'II' ? '15/08/' : '15/04/'
                fechaMatricula = tempFechaRegistration + _data[i].Academic_semester.Academic_calendar.denomination.substr(-4);
                admissionPlan = _data[i].Student && _data[i].Student.Admission_plan && _data[i].Student.Admission_plan.description ? _data[i].Student.Admission_plan.description.substr(8) : 'No def';
                data.push({
                    ...
                    'MODALIDAD_ESTUDIO': modalidaEstudio === 'Presencial' ? 1 : modalidaEstudio === 'Semi-Presencial' ? 2 : 3,
    ...
    reportExcelRegistration: async (req, res) => {
        ...
        try {
            ...
            let programa, unidadorganica, sede, documento, nombre, apellidopaterno, apellidomaterno;
            for (let i = 0; i < students.length; i++) {
                programa = students[i].Student && students[i].Student.Program ? students[i].Student.Program.denomination : null;
                unidadorganica = students[i].Student && students[i].Student.Organic_unit_register ? students[i].Student.Organic_unit_register.denomination : null;
                sede = students[i].Student && students[i].Student.Organic_unit_register && students[i].Student.Organic_unit_register.Campu ? students[i].Student.Organic_unit_register.Campu.denomination : null;
    ...
    reportExecelMovementStudentByRangeDate: async (req, res) => {
        ...
        try {
            ...
            organicUnitDenomination = organictUnit.denomination + '-' + organictUnit.Campu.denomination;
            principalOrganit = principalOrganicUnit.description;
            const movements = await Movement.findAll({
                attributes: ['state', 'type', 'voucher_amount', 'voucher_code', 'voucher_date', 'voucher_url', 'denomination', 'observation'],
                where: {
                    voucher_date: {
            ...
            let voucherCode, voucherDate, dni, person, voucherAmount, admisionPlan, voucherUrl, denomination,
                observation;
            for (let i = 0; i < movements.length; i++) {
                voucherDate = movements[i].voucher_date,
                    ...
                    admisionPlan = movements[i].Student.Admission_plan.description,
...
reportDataMovementStudentByRangeDateRegistrationVoucher: async (req, res) => {
        let dataExcel = [];
        let dataPdf = [];
        let totalAmount = 0;
        let organicUnitDenomination = '';
        ...
        try {
            ...
            principalOrganit = principalOrganicUnit.description;
            const movements = await Movement.findAll({
                attributes: ['state', 'type', 'voucher_amount', 'voucher_code', ['created_at', 'voucher_date'], 'voucher_url', 'denomination', 'observation'],
                where: {
                    state: 'Aceptado',
                    created_at: {
                        [Op.between]: [req.body.start_movement, req.body.end_movement],
                    },
                    id_organic_unit: req.body.id_organict_unit
                },
                include: [
    ...
    reportCertyStudy2: async (req, res) => {
        ...
        let totalCourse = 0;
        try {
            const documentBook = await Document_book.findByPk(req.params.id_document_book);
            const principalOrganicUnit = await System_configuration.findOne({
                attributes: ['description', 'description_document', 'abbreviation'],
                where: {state: true}
            });
            ...
            const studentData = await Student.findOne({
                ...
                include: [
                    {
                        attributes: ['document_number', 'photo', [Fn('CONCAT', Col('name'), ' ', Col('paternal'), ' ', Col('maternal')), 'name']],
                        model: Person,
                        as: 'Person'
                    },
                    {
            ...
            let course, cicle, _cicle, process, _process, order, year, credit, note = '';
            if (_dataRegistration.length > 0) {
                for (let i = 0; i < _dataRegistration.length; i++) {
                    ...
                    for (let j = 0; j < _dataRegistration[i].Course.length; j++) {
                        ...
                        leterNote = await abox.numberToLetter(_dataRegistration[i].Course[j].R_c.note);
                        year = _dataRegistration[i].Course[j] && _dataRegistration[i].Course[j].R_c.Registration.A_s.A_c.denomination;

                        process = _dataRegistration[i].Course[j].R_c.Registration.A_s.denomination;
            ...
            observation = documentBook.observation ? documentBook.observation : '';
    ...
    reportConstancyStudy: async (req, res) => {
        ...
        try {
            ...
            const studentData = await Student.findOne({
                ...
                include: [
                    {
                        attributes: ['document_number', [Fn('CONCAT', Col('name'), ' ', Col('paternal'), ' ', Col('maternal')), 'name']],
                        model: Person,
                        as: 'Person'
                    },
                    {
            ...
            ciclo = _dataRegistration.length > 0 ? _dataRegistration[0].ciclo : '?';
            correlative = documentBook.correlative + '-' + moment(documentBook.created_at).year();
            date = moment(documentBook.created_at).format('LL');
            res.status(200).send({
                principalOrganicUnit,
    ...
    reportConstancyExpedito: async (req, res) => {
        ...
        try {
            ...
            firtsRegister = studentRegister[0] && studentRegister[0].Academic_semester.Academic_calendar.denomination.substr(-4) + '-' + studentRegister[0].Academic_semester.denomination.substr(-2);
            lastRegister = studentRegister[studentRegister.length - 1] && studentRegister[studentRegister.length - 1].Academic_semester.Academic_calendar.denomination.substr(-4) + '-' + studentRegister[studentRegister.length - 1].Academic_semester.denomination.substr(-2);
            correlative = documentBook.correlative + '-' + moment(documentBook.created_at).year();
            date = moment(documentBook.created_at).format('LL');
            res.status(200).send({
                principalOrganicUnit,
    ...
    reportConstancyEgress: async (req, res) => {
        ...
        try {
            ...
            studentRegister = await Registration.findAll({
                ...
                order: [
                    ['created_at', 'asc'],
                    [{model: Registration_course, as: 'Registration_course'}, 'created_at', 'asc']
            ...
            for (let i = 0; i < studentRegister.length; i++) {
                for (let j = 0; j < studentRegister[i].Registration_course.length; j++) {
                    tempDates.push(moment(studentRegister[i].Registration_course[j].Schedule.start_date))
                    tempDatesEnd.push(moment(studentRegister[i].Registration_course[j].Schedule.end_date))
                }
            }
        ...
        try {
            ...
            students = await Student.findAll({
                ...
                include: [
                    ...
                    },
                    {
                        ...
                        as: 'Registration',
                        include: {
                            attributes: ['id', 'id_course', 'id_schedule', 'type_course', 'note', 'state'],
                            where: {state: 'Aprobado'},
                            model: Registration_course,
                            as: 'Registration_course'
                        }
            ...
            for (let i = 0; i < students.length; i++) {
                ...
                for (let j = 0; j < students[i].Registration.length; j++) {
                    ...
                    for (let k = 0; k < students[i].Registration[j].Registration_course.length; k++) {
                        promedy = promedy + students[i].Registration[j].Registration_course[k].note
                        totalCourse = totalCourse + 1
            ...
            tempStudent.sort((a, b) => parseFloat(a.note) < parseFloat(b.note) ? 1 : -1);
    ...
    reportAcademicRecord: async (req, res) => {
        ...
        try {
            ...
            registrationData = await Registration.findAll({
                attributes: ['id', 'id_semester', 'type', 'state', 'deleted_at'],
                where: {id_student: req.params.id_student},
                include: [
                    {
                        required: true,
                    ...
                    {
                        required: true,
                        attributes: ['id', 'id_course', 'id_schedule', 'note', 'state'],
                        model: Registration_course,
                        as: "Registration_course",
                        include: {
                            attributes: ['id', 'id_ciclo', 'denomination', 'order', 'credits', 'type', 'state'],
                            model: Course,
                            as: "Course",
                            include: {
                                // attributes: ['ciclo'],
                ...
                order: [
                    ...
                    [
                        {model: Registration_course, as: 'Registration_course'},
            ...
            for (let i = 0; i < registrationData.length; i++) {
                registration.push({
                    ...
                    "Academic_semester": {
                        ...
                        "denomination": registrationData[i].Academic_semester.denomination.substr(-2),
                        "Academic_calendar": {
                            "id": registrationData[i].Academic_semester.Academic_calendar.id,
                            "denomination": registrationData[i].Academic_semester.Academic_calendar.denomination.substr(-4),
                        }
                    },

                    "Registration_course": []
                })
                for (let j = 0; j < registrationData[i].Registration_course.length; j++) {
                    registration[i].Registration_course.push({
                        "id": registrationData[i].Registration_course[j].Course.id,
                        "denomination": registrationData[i].Registration_course[j].Course.denomination,
                        "order": registrationData[i].Registration_course[j].Course.order,
                        "credits": registrationData[i].Registration_course[j].Course.credits,
                        "type_course": registrationData[i].Registration_course[j].Course.type,
                        "ciclo": registrationData[i].Registration_course[j].Course.Ciclo.ciclo,
                        "state": true,
                        "note_state": registrationData[i].Registration_course[j].state === 'Sin nota' ? true : false, //genero este estado para poder manejar mejor en la vista
                        //registration table
                        "id_registration": registrationData[i].Registration_course[j].id,
                        "id_schedule": registrationData[i].Registration_course[j].id_schedule,
        ...
        try {
            ...
            res.status(200).send({
                registration: {
                    ...
                    process: registration.Academic_semester.Academic_calendar.denomination.substr(-4) + ' ' + registration.Academic_semester.denomination.substr(-2),
                },
                studentData,
                registrationData
            });
    ...
    reportActa: async (req, res) => {
        ...
        try {
            ...
            const teacher = await Teacher.findOne({
                ...
                as: 'Teacher',
                include: {
                    attributes: [[Fn('CONCAT', Col('name'), ' ', Col('paternal'), ' ', Col('maternal')), 'name']],
            ...
            const campus = acta.Program.Organic_unit_register.Campu.denomination.toUpperCase();
            const program = acta.Program.denomination.toUpperCase();
            const faculty = acta.Program.Organic_unit_origin.denomination.toUpperCase();
            let students = [];
            ...
            const data = {
                ...
                semester: acta.Academic_semester.Academic_calendar.denomination.substr(-4) + '-' + acta.Academic_semester.denomination.substr(-2),
                Course: {
    ...
    reportStudyPlan: async (req, res) => {
        ...
        try {
            ...
            const data = await Plan.findOne({
                attributes: ['description', 'credit_required', 'credit_elective'],
            ...
            const courses = await Ciclo.findAll({
                ...
                include: {
                    attributes: ['id', 'code', 'order', 'denomination', 'credits', 'type', 'practical_hours', 'hours', 'area', 'requirements'],
                    required: true,
                    model: Course,
                    as: 'Course'
                },
            ...
            for (let i = 0; i < courses.length; i++) {
                ...
                for (let j = 0; j < courses[i].Course.length; j++) {
                    let _array = JSON.parse(courses[i].Course[j].requirements) || []
                    let _array_order = '';
        ...
        try {
            ...
            await ST.transaction(async (t) => {
                ...
                let _payments = await Student.findAll({
                    ...
                    include: [
                        {
                            where: {
                                ...
                                id_concept: {[Op.or]: [81, 82, 83, 84, 85, 3, 4, 94, 8, 92]}
                            },
                            required: true,
                            // attributes: ['voucher_code', 'voucher_amount', 'voucher_date', 'voucher_url', 'observation', 'type', 'state', 'created_at', 'updated_at'],
                            model: Payment,
                    ...
                    order: [[{model: Payment, as: 'Payment'}, 'created_at', 'asc']],
                }, {transaction: t});
                //ORDENAMOS POR DNI
                payments = await _.groupBy(_payments, ({Person: {document_number}}) => `${document_number}`)
                ...
                for (let i = 0; i < claves.length; i++) {
                    ...
                    if (type === 'Inscripción') {
                        dataExcel.push({
                            ...
                            'INSCRIPCIÓN': payments[clave][0] == null ? 'Null' : payments[clave][0].Payment.type === 'Pagado' ? payments[clave][0].Payment.amount : '-',
                            'MATRÍCULA': payments[clave][1] == null ? 'Null' : payments[clave][1].Payment.type === 'Pagado' ? payments[clave][1].Payment.amount : '-',
                            'COUTA 1': payments[clave][2] == null ? 'Null' : payments[clave][2].Payment.type === 'Pagado' ? payments[clave][2].Payment.amount : '-',
                            'COUTA 2': payments[clave][3] == null ? 'Null' : payments[clave][3].Payment.type === 'Pagado' ? payments[clave][3].Payment.amount : '-',
                            'COUTA 3': payments[clave][4] == null ? 'Null' : payments[clave][4].Payment.type === 'Pagado' ? payments[clave][4].Payment.amount : '-',
                            'COUTA 4': payments[clave][5] == null ? 'Null' : payments[clave][5].Payment.type === 'Pagado' ? payments[clave][5].Payment.amount : '-',
                            'COUTA 5': payments[clave][6] == null ? 'Null' : payments[clave][6].Payment.type === 'Pagado' ? payments[clave][6].Payment.amount : '-',
                            'COUTA 6': payments[clave][7] == null ? 'Null' : payments[clave][7].Payment.type === 'Pagado' ? payments[clave][7].Payment.amount : '-',
                            'COUTA 7': payments[clave][8] == null ? 'Null' : payments[clave][8].Payment.type === 'Pagado' ? payments[clave][8].Payment.amount : '-',
                            'COUTA 8': payments[clave][9] == null ? 'Null' : payments[clave][9].Payment.type === 'Pagado' ? payments[clave][9].Payment.amount : '-',
                        ...
                        dataExcel.push({
                            'ID': i + 1,
                            'ESTUDIANTE': payments[clave][0].Person.name,
                            'MATRÍCULA': payments[clave][0] == null ? 'Null' : payments[clave][0].Payment.type === 'Pagado' ? payments[clave][0].Payment.amount : '-',
                            'COUTA 1': payments[clave][1] == null ? 'Null' : payments[clave][1].Payment.type === 'Pagado' ? payments[clave][1].Payment.amount : '-',
                            'COUTA 2': payments[clave][2] == null ? 'Null' : payments[clave][2].Payment.type === 'Pagado' ? payments[clave][2].Payment.amount : '-',
                            'COUTA 3': payments[clave][3] == null ? 'Null' : payments[clave][3].Payment.type === 'Pagado' ? payments[clave][3].Payment.amount : '-',
                            'COUTA 4': payments[clave][4] == null ? 'Null' : payments[clave][4].Payment.type === 'Pagado' ? payments[clave][4].Payment.amount : '-',
                            'COUTA 5': payments[clave][5] == null ? 'Null' : payments[clave][5].Payment.type === 'Pagado' ? payments[clave][5].Payment.amount : '-',
                            'COUTA 6': payments[clave][6] == null ? 'Null' : payments[clave][6].Payment.type === 'Pagado' ? payments[clave][6].Payment.amount : '-',
                            'COUTA 7': payments[clave][7] == null ? 'Null' : payments[clave][7].Payment.type === 'Pagado' ? payments[clave][7].Payment.amount : '-',
                            'COUTA 8': payments[clave][8] == null ? 'Null' : payments[clave][8].Payment.type === 'Pagado' ? payments[clave][8].Payment.amount : '-',
    ...
    reportLiquidationByAdmissionPlan: async (req, res) => {
        ...
        try {
            ...
            inscriptionData.map(r => {
                totalInscription = parseFloat(r.Payment.amount) + totalInscription
            })
            ////TOTAL REGISTRATION
            ...
            dataRegistration.map(r => {
                totalRegistration = parseFloat(r.Payment.amount) + totalRegistration
            })
            ////TOTAL PENSION
                ...
                include: [
                    {
                        ...
                        required: true, model: Payment, as: "Payment",
                        where: {
                            type: 'Pagado',
                            [Op.and]: [
            ...
            serviceMaterialEgress.map(r => {
                egressServiceMaterial = parseFloat(r.amount) + egressServiceMaterial
            })
            ...
            administrativeData.map(r => {
                egressAdministrative = parseFloat(r.amount) + egressAdministrative
            });
            //TOTAL BALANCE
            //////////////////////////////////////////////////////////////////////////////////
            ///////////////////////////////////TOTAL BALANCE/////////////////////////////////////////
            ...
            totalMovement.map(r => {
                _totalMovement = parseFloat(r.Movement.voucher_amount) + parseFloat(_totalMovement)
            });
            ...
            totalPayment.map(r => {
                _totalPayment = parseFloat(r.Payment.amount) + parseFloat(_totalPayment)
            });
            ...
            //////////////////////////////////////////////////////////////////////////////////////////
            let subTotalEntry = totalInscription + totalRegistration + totalPension + totalOther;
            let subTotalEgress = egressAdministrative + egressServiceMaterial + egressTeacher;
    ...
    chartInscriptionProcess: async (req, res) => {
        try {
            ...
            await ST.transaction(async (t) => {
                ...
                const mpp = new Map(students.map(o => [o.id, {denomination: o.denomination}]));
                const resultp = Array.from(mpp.values());
                let finalResulp = []
                for (let i = 0; i < resultp.length; i++) {
                    finalResulp.push(
                        resultp[i].denomination
                    )
                }
                // console.log(result)
                data = {'cant': finalResult, 'program': finalResulp, 'total': totalResult};
            });
            res.status(200).send(data);
        } catch (err) {
            console.log(err)
            ...
            await ST.transaction(async (t) => {
                students = await Program.findAll({
                    ...
                    include: [
                        ...
                        {
                            attributes: ['id'],
                            where: {type: 'Egresado', id_process_egress: req.params.id_process},
                            required: true,
                            model: Student,
                            as: 'Student'
                        }
                ...
                students = await Program.findAll({
                    ...
                    include: [
                        ...
                        },
                        {
                            ...
                            as: 'Admission_plan',
                            include: {
                                where: {required_document: req.params.state},
            ...
            await ST.transaction(async (t) => {
                ...
                for (let i = 0; i < records.length; i++) {
                    ...
                    for (let j = 0; j < records[i].Movements.length; j++) {
                        sub = parseFloat(records[i].Movements[j].voucher_amount) + sub
                    }
                    amounts.push(sub)
                }
        ...
        try {
            ...
            await ST.transaction(async (t) => {
                ...
                for (let i = 0; i < records.lenght; i++) {
                    units.push(records[i].denomination + '-' + records[i].denomination)
                    for (let k = 0; k < records[i].Egresss.length; k++) {
                        subEgress = parseFloat(records[i].Egresss[k].amount) + subEgress
                    }
                }
                ...
                const _data = await Payment.findAll({
                    ...
                    include: [
                        ...
                        },
                        {
                            ...
                            as: 'Student',
                            include: {
                                attributes: ['id', 'document_number', 'email', 'photo', 'phone', [Fn('CONCAT', Col('name'), ' ', Col('paternal'), ' ', Col('maternal')), 'name']],
                                model: Person,
                                as: 'Person'
                            }
                        },
            ...
            await ST.transaction(async (t) => {
                ...
                for (let i = 0; i < size; i++) {
                    let temp = await Registration_course.create({
                        ...
                        "deleted_at": record[i].deleted_at ? '2021-02-05 12:32:49.602-05' : null,
                    }, {transaction: t});
                    newData.push(temp)
                ...
                for (let i = 0; i < registration.length; i++) {
                    for (let j = 0; j < registration[i].Registration_course.length; j++) {
                        ...
                        let tempSchedule = await Schedule.create({
                            "id": y,
                            "id_course": registration[i].Registration_course[j].id_course,
            ...
            await ST.transaction(async (t) => {
                ...
                for (let i = 0; i < schedules.length; i++) {
                    ...
                    for (let j = 0; j < unicos.length; j++) {
                        ...
                        if (unicos[j].id_course === schedule.id_course && unicos[j].id_process === schedule.id_process) {
                            esDuplicado = true;
                            break;
                        }
                    }
            ...
            await ST.transaction(async (t) => {
                ...
                for (let i = 0; i < schedules.length; i++) {
                    ...
                    for (let j = 0; j < registrationCourses.length; j++) {
                        for (let k = 0; k < registrationCourses[j].Registration_course.length; k++) {
                            // let registationCourseTemp = await Registration_course.findByPk(registrationCourses[j].Registration_course[k].id);
                            let registationCourseTemp = await registrationCourses[j].Registration_course[k].update({
            ...
            await ST.transaction(async (t) => {
                ...
                for (let i = 0; i < size; i++) {
                    for (let j = 0; j < record[i].Registration.length; j++) {
                        ...
                        let temp = await Registration.findByPk(record[i].Registration[j].id);
                        await temp.update({
        ...
        try {
            ...
            await ST.transaction(async (t) => {
                ...
                for (let i = 0; i < record.length; i++) {
                    ...
                    let stageProcess = record[i].Registration[size - 1].id_semester;
                    for (let j = 0; j < record[i].Registration.length; j++) {
                    ...
                    for (let i = 0; i < studentData.length; i++) {
                        ...
                        await temp.update({
                            type: 'Egresado',
                            id_process_egress: studentData[0].id_process_egress
                        }, {transaction: t});
                        newData.push(temp)
                    }
                    await Promise.all(newData)
            ...
            await ST.transaction(async (t) => {
                ...
                for (let i = 0; i < temp.length; i++) {
                    data.push({
                        ...
                        "deleted_at": temp[i].deleted_at !== '' ? temp[i].deleted_at : null
                    })
                }
            ...
            await ST.transaction(async (t) => {
                ...
                for (i; i < students.length; i++) {
                    let requerimets = await Requeriment.findAll({
                        where: {
                            id_academic_degree: students[i].Program.id_academic_degree,
                            id_concept: students[i].id_concept
                        }

                    }, {transaction: t})
                    let j = 0;
                    for (j; j < students[i].Requeriment_delivereds.length; j++) {
        ...
        try {
            ...
            await ST.transaction(async (t) => {
                ...
                data = await Student.findAll({
                    attributes: ['id'],
                    include: {
                        attributes: ['id', 'id_concept', 'order_number', 'created_at'],
                        model: Payment,
                        as: 'Payments',
                        where: {id_concept: 85}
                    },
                    order: [[{model: Payment, as: 'Payments'}, 'created_at', 'asc']],
                });
