...
const Model = require('../../models').Activity_type;
module.exports = {
    createActivityType: function (req, res) {
        return Model
    ...
    listActivityType: function (req, res) {
        return Model
    ...
    retrieveActivityType: function (req, res) {
        return Model
            .findOne({
                where: {
                    id: {
    ...
    updateActivityType: function (req, res) {
        return Model
            .findOne({
                where: {
                    id: {
    ...
    destroyActivityType: function (req, res) {
        return Model
            .findOne({
                where: {
                    id: {
